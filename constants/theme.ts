...
export const Colors = {
  light: {
    ...
    innerCardBackground: "#e0e0e0ff",
    cardBorder: 'rgb(59, 59, 59)',
    cardTable: "#afafafff",
    cardTableBorder: "#2f2f2fff",
    cardImage: "#a2a2a2ff",
    cardImageBackground: "e0ff",
...
backGroundGradient: [
  ...
  "rgb(12, 13, 14)",
    ...
    purple: "#a159aeff",
    cardBackground: "rgb(43, 45, 47)",
    innerCardBackground: "rgb(55, 57, 63)",
    cardBorder: 'rgb(59, 59, 59)',
    cardTable: "#606060ff",
    cardTableBorder: "#a2a2a2ff",
    cardImage: "rgb(93, 88, 88)",
    cardImageBackground: "rgb(55, 57, 62)",
    searchBackground: "rgb(43, 45, 47)",
